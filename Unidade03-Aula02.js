...
// Tipagem DINÂMICA (não preciso atribuir o TypeOf, o JS ACEITA a troca e infere o valor e tipo...) JS = UnTyped

let minhaVar = 567;
minhaVar = 'texto'; 

// JS é uma linguagem MULTIPARADIGMA... E existe também a Linguagem INTERPRETADA (mais denso e prática) e a COMPILADA (mais rápida mas precisa do intermediário). 
// NodeJS é um INTERPRETADOR do JS no Back-End. O navegador é o interpretador no Front-End. 
