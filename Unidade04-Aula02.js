...
// A == B (Comparação Implícita)
// Compara, com conversão implícita dos tipos, ANTES de fazer a comparação de valores... 
...
// A === B
// Compara de modo mais específico, sem comparar os tipos primeiro, então compara DIRETO os valores sem ser iguais um número e uma string...

// BOAS PRÁTICAS DE PROGRAMAÇÃO não usam comparação implícita (==), mas é preferível fazer sempre comparações (===), e quando houver diferenças nos tipos, efetuar a conversão dos tipos EXPLICITAMENTE no código, e.g.: transformando string em número ou vice-versa.
