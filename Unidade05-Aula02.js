// FUNÇÕES - Declara e Executa funções, evitando repetição e aumentando a abstração...

let x = "";
console.log(x);
x = "oi";

// #1 Declara a Function (string)
function imprimeTexto (texto) {
    console.log(texto);
}

// #2 Executa (chamando) a função
imprimeTexto("oi");
imprimeTexto("Uma outra string com outro texto")
...
soma();
console.log(soma()); // undefined... (não retornou nada)

function soma2(){
    return 2 + 2; // A última linha antes de fechar um bloco de uma função é um return pra devolver o resultado do bloco.
}

console.log(soma2());

imprimeTexto(soma2()); // Função dentro de uma função... ;)
