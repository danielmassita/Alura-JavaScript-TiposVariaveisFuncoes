...
function multiplica(numero1 = 1, numero2 = 1){ // Adicionei um valor padrão (1 que é neutro) para os parâmetros...
    return numero1 * numero2;
}
console.log(multiplica(soma(4,5), soma(3, 3)));
console.log(multiplica(soma(4,5))); // NaN (pois tenta multiplicar 9 com undefined)
